...
enum Histograms : uint32_t {
  ...
  LCOMPACTION_OUTPUT_RAW_BYTES, // sum of kv raw data in all file
  LCOMPACTION_OUTPUT_ZIP_BYTES, // sum of all file on disk
  DCOMPACTION_OUTPUT_RAW_BYTES,
  DCOMPACTION_OUTPUT_ZIP_BYTES,

  SWITCH_WAL_MICROS,
  MEMTAB_CONSTRUCT_MICROS,
