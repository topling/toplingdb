...
const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap = {
    ...
    {LCOMPACTION_OUTPUT_RAW_BYTES, "rocksdb.lcompaction.output.raw.bytes"},
    {LCOMPACTION_OUTPUT_ZIP_BYTES, "rocksdb.lcompaction.output.zip.bytes"},
    {DCOMPACTION_OUTPUT_RAW_BYTES, "rocksdb.dcompaction.output.raw.bytes"},
    {DCOMPACTION_OUTPUT_ZIP_BYTES, "rocksdb.dcompaction.output.zip.bytes"},
