...
class DBIter final : public Iterator {
 ...
 private:
  ...
  bool RocksPrepareValue() {
    ParsedInternalKey ikey;
    return RocksPrepareValue(ikey);
  }
  bool RocksPrepareValue(ParsedInternalKey& ikey_) {
  ...
  Slice pinned_value_; // ToplingDB: restore to field, slow conform to rocksdb
