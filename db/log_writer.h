...
class Writer {
 public:
  ...
  // num_parts is the number of parts in the array. parts[0] is reserved for
  // the header. parts[1] is the first part of the payload. parts[num_parts-1]
  // is the last part of the payload. the number of the payload parts is
  // num_parts - 1. The header will be generated by the writer.
  // the part_crc32c_checksums is the array of precomputed crc32c checksums
  // for each part.
  IOStatus AddRecordv(Slice* parts, size_t num_parts, size_t sum_len,
  ...
  void InitReaderMmap(FileSystem& fs, size_t mmap_size);
